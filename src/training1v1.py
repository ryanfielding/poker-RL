...
load_model = False
#path = '/content/drive/My Drive/PokerRLModels/poker-RL/src/cache/models/DQN2Plots/DQN' #on colab
path = '/Users/Ryan/Repos/poker-RL/src/cache/models/DQN2Plots/DQN'
