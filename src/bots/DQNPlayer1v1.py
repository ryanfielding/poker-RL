...
class DQNPlayer(BasePokerPlayer):
    ...
    def __init__(self, h_size=128, lr=0.0001, gradient_clip_norm=500, total_num_actions=5, is_double=True,
                 is_main=True, is_restore=True, is_train=False, debug=False):          
        super().__init__() #added for gui
        self.h_size = h_size
        self.lr = lr
...
#             self.update_model = self.trainer.minimize(self.loss)
            ...
            self.summary_writer = tf.compat.v1.summary.FileWriter('./log/DQN2/')
        ...
        if is_restore:
            ...
            ckpt = tf.train.get_checkpoint_state('/Users/Ryan/Repos/poker-RL/src/bots/models/DQN2/')
            print("path = ", ckpt)
